...
export default function ReportsPage() {
  ...
  return (
    <>
      <AppHeader title="Insights" description="Live numbers, no spreadsheet required." action={<button type="button" onClick={() => void send()} disabled={sending} className="primary-solid hidden h-10 items-center gap-2 rounded-[14px] px-3 text-[10px] font-bold sm:flex"><Mail className="size-3.5" /> {sending ? "Sending..." : "Email brief"}</button>} />
